...
public class Login extends AppCompatActivity {
          ...
          .addOnCompleteListener(Login.this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
              if (task.isSuccessful()) {
                ...
                Log.e(this.toString(),
                    "creating of user account has failed due to" + task.getException());
              }
            }
          });
    }
    ...
    if (checkFormatOfEmail(email) && checkFormatOfPassword(password)) {
      ...
      mAuth.signInWithEmailAndPassword(email, password)
          .addOnCompleteListener(Login.this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
              if (task.isSuccessful()) {
                Log.d(Login.this.getClass().toString(), "signInWithEmail:success");
                goToMainActivity();
              } else {
                Log.e(Login.this.getClass().toString(), "signInWithEmail:failure",
                    task.getException());
              }
            }
          });
  ...
  private void goToMainActivity() {
    Log.d(Login.this.getClass().toString(), "Redirecting user to Main");
